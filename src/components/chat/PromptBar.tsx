    ...
    <>
      <div className="relative flex flex-col">
        <textarea
          ...
          rows={1}
          className={`min-h-[54px] max-h-[144px] w-full resize-none bg-transparent px-3.5 py-3.5 text-[15.5px] leading-[1.625] outline-none placeholder:text-muted-foreground/50 ${isScrollable ? "overflow-y-auto [scrollbar-width:thin] [scrollbar-color:theme(colors.slate.200)_transparent] hover:[scrollbar-color:theme(colors.slate.300)_transparent] [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar]:bg-transparent [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:!bg-slate-200 hover:[&::-webkit-scrollbar-thumb]:!bg-slate-300 active:[&::-webkit-scrollbar-thumb]:!bg-slate-300 [&::-webkit-scrollbar-thumb:hover]:!bg-slate-300 [&::-webkit-scrollbar-thumb:active]:!bg-slate-300" : "overflow-hidden [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"}`}
